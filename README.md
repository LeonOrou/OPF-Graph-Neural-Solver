...
The goal of this work is to predicting v and theta at each bus of a MATPOWER power grid, paper can be found [here](https://drive.google.com/file/d/1mstJIg23Qqbw5eRdZWL3z1w2NrFTDV7b/view?usp=sharing).
